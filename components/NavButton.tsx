...
export default function NavButton(props: { styles: any; source: any; width: any; height: any; alt: any; items: any; hasList: boolean; squareWidth: string }) {
        ...
        <div className={styles.NavButton}>
            ...
            {props.hasList &&
                <>
                    ...
                    <div className={styles.list} style={{ width: props.squareWidth ?? '100px' }}>
                        {
